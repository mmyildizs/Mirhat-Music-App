...
public class UPSBGController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        String psbg = "SELECT SarkiName,SanatciName,DinlenmeSayisi,Tür,Süre FROM mirhats_sarki ORDER BY DinlenmeSayisi DESC";

        try
        {
            Statement statement1 = connectDB.createStatement();
            ResultSet queryOutput = statement1.executeQuery(psbg);

            Statement statement2 = connectDB.createStatement();
            ResultSet queryOutput2 = statement2.executeQuery(psbg);

            Statement statement3 = connectDB.createStatement();
            ResultSet queryOutput3 = statement3.executeQuery(psbg);

            Statement statement4 = connectDB.createStatement();
            ResultSet queryOutput4 = statement4.executeQuery(psbg);

            Statement statement5 = connectDB.createStatement();
            ResultSet queryOutput5 = statement5.executeQuery(psbg);
