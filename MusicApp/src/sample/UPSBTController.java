...
public class UPSBTController implements Initializable {
    @FXML
    ...
    public void viewButtonAction(ActionEvent event)
    {
        ...
        String psbt = "SELECT SarkiName,SanatciName,DinlenmeSayisi,Tür,Süre FROM mirhats_sarki WHERE Tür='"+typeTextField.getText()+"' ORDER BY DinlenmeSayisi DESC";

        try {
            Statement statement1 = connectDB.createStatement();
            ResultSet queryOutput = statement1.executeQuery(psbt);

            Statement statement2 = connectDB.createStatement();
            ResultSet queryOutput2 = statement2.executeQuery(psbt);

            Statement statement3 = connectDB.createStatement();
            ResultSet queryOutput3 = statement3.executeQuery(psbt);

            Statement statement4 = connectDB.createStatement();
            ResultSet queryOutput4 = statement4.executeQuery(psbt);

            Statement statement5 = connectDB.createStatement();
            ResultSet queryOutput5 = statement5.executeQuery(psbt);
